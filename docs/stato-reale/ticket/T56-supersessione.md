...
## 6quater. La direzione: decisa, non più aperta

**Decisione del ruolo di controllo, col mandato, 13 settembre 2026.**

> Le tre porte devono dare **lo stesso verdetto** e applicarlo **nello stesso
> modo**, e quel modo è **versionare**: il vecchio prende `superseded_by` e una
> maniglia di annullamento, resta nel corpus e si legge chiedendo la storia.
> Non cancellare.

⇒ Cade l'obiezione che questo ticket portava da agosto — «ritirare significa
mangiare fatti veri» — perché un ritiro che lascia la riga, la maniglia e una
lettura che la rende **non è una cancellazione**. La perdita che il ticket
misura nasceva dal ritiro *senza* quelle tre cose.

⇒ E cade anche la seconda strada: **non si collega
`contradicting_fact_ids`** alla riga di comando. Il gate calcola due liste
(quella è l'altra, e quarantina la scrittura NUOVA); il verdetto che le tre
porte applicano è uno solo, attraverso la funzione unica introdotta con la cura
di questo ticket. Una porta con due strade verso lo stesso effetto è il difetto
da cui veniamo, in una forma nuova.

📌 Resta di chi disegna il prodotto la scelta di *come* la lettura mostra le
versioni precedenti; qui si fissa che ci sono e che si raggiungono.
